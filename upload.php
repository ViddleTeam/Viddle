...
<div class="container" style="margin-top:30px;">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="alert alert-warning" role="alert" style="width: 100%; text-align: center;"><B>UWAGA:</b> Niedługo po świętach wielkiejnocy wycofamy tego uploadera. Zachęcamy do przejścia na  <a href="newupload.php" class="alert-link">nowy uploader</a>. Wspiera on nowe funkcje serwisu i jest wygodniejszy.</div>
