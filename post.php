  ...
  if (is_uploaded_file($_FILES['videovid']['tmp_name'])) {
	  ...
	  {	
	    ...
	    if ($res != -1) {
	      ...
	      $returnedvalue = shell_exec('ffmpeg -i $videocompress --enable-protocols -b:v 5000k -bufsize 5000k ftp://cdn_viddle@viddle.xyz:uaX9WprQfEO}@ftp.oliwierj.webd.pro:21/videos/test/output.mp4 2>&1');
	      //echo "Wrzucono film.";
	      $uplsuccess = 1;
	    }
