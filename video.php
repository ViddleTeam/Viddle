                ...
                <div class="col-md-7">
                  ...
                  <span style="margin-left: 10px;">
                    ...
                    <span style="margin-left: 10px; margin-right: auto;">
                      ...
                      <span style='margin-right: 5px;'><a href="like.php?id=<?php echo $id ?>">"<i class="fas fa-arrow-up"></i> <?php echo $likes ?></a></span> <a href="dislike.php?id=<?php echo $id ?>"><i class="fas fa-arrow-down" style="margin-left: 10px; margin-right: 5px;"></i> <?php echo $dislikes ?></a>
                    </span>
