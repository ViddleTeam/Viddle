            ...
            <div class="form-row">
                <div class="col-md-7">
                    <div class="md-form form-group">
                        <iframe src="https://cdn.plrjs.com/player/frb26f6hndyna/d838dwutz4s3.html?file=https://viddlecdn.ml/videos/<?php echo $id ?>/<?php echo $file ?>&title=<?php echo $title ?>" type="video/mp4" width="640" height="360" frameborder="0" allowfullscreen=""></iframe>
				  ...
				  <i class="fas fa-eye"></i><?php echo $views ?></h4>
