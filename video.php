...
// 					
				  ...
				  <i class="fas fa-eye" style="margin-right: 5px;"></i><?php echo $views ?></h4>
                      <a href="" style="color: white;"><i class="fas fa-arrow-up" style="margin-right: 5px;"></i></a> <?php echo $likes ?> <i class="fas fa-arrow-down" style="margin-left: 10px; margin-right: 5px;"></i> <?php echo $dislikes ?>
                    </span>
                            </div><br>
                            <p><?php echo $opis ?></p>
                        </div>
