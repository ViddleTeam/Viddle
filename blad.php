...
if($id=="1") {
  ...
  $test = "Twój plik jest za duży, lub użyłeś złęgo formatu pliku!<br />Dozwolone formaty: .mp4, .wmv, .webm, .mov, .3gp<br />Maksymalny rozmiar pliku: 10 MB<br />Jeżeli problem nie ustąpi, skontaktuj się z deweloperami strony.<br /><h3>Kod błędu: 0x00002c</h3>";
} elseif($id=="3") {
  ...
  $test = "Heh, śmieszne. Wystąpił błąd taki, że w linku nie podano kodu błędu. Śmieszne, co nie?<br />";
}
?>
