            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent-6">
                ...
                <ul class="navbar-nav nav-flex-icons" style="margin-right: 10px;">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle waves-effect waves-light" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img width="32px" style="border-radius:50%;margin-right:5px;" class="img-responsive" src="<?php echo 'avatardomyslny.png' ?>"></a>
