                ...
                <ul class="navbar-nav nav-flex-icons" style="margin-right: 10px;">
                    <div class="container row">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-light" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="https://media.discordapp.net/attachments/785086822220169217/796438592850362378/viconupload.png?width=117&height=72" width="20px" style="color: white;" /> <span class="d-lg-none">Udostępnij film</span></a>
