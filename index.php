...
<head>
	<!-- <script>
      ...
      <div class="container" style="margin-top:30px;">
        ...
        <span class="alert alert-warning" style="margin-top: 50px;"><b>UWAGA:</b> część funkcji nie jest dla ciebie dostępna z powodu niezweryfikowanego adresu e-mail <a href='mverify.php'>Zweryfikuj teraz</a></span>  
          <div class="row">
              <div class="col-lg-12">
