...
?>
      ...
      <div class="container my-5" style="margin-top:20px; margin: auto; justify-content: center;">
		...
		<div class="banner mx-auto">
			...
			<div class="bottom-radius" style="height: 100px; width: 100%; margin-left: 0px; margin-right: 0px; margin-top: -30px;">
		...
		<div class="container" style="margin-top:20px;">
			...
			<div class="container row" style="min-width: 100% !important;">
