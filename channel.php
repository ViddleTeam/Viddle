...
if ($result = @$connect->query(
	...
	if($d2 == '1')
	{
		...
		if($ba2 == 'x') {
			...
			$ba3 = 'https://cdn.viddle.xyz/cdn/videos/banners/'.$id.'/'.$id.'b.'.$dane['banername'].'';
		}
    ...
    $('[data-toggle="tooltip"]').tooltip();
      ...
      <div class="container my-5" style="margin-top:20px; margin: auto; justify-content: center;">
		...
		<div class="banner mx-auto">
			<img class="img-fluid banner" src="<?php if (isset($ba3)) echo $ba3; ?>" style="margin: auto; overflow: hidden; max-height: 190px;" height="20%" width="100%" alt="Baner kanału" />
		</div>
			<div class="card-channel" style="height: 100px; width: 100%; margin-top: -20px; margin-left: 0px; margin-right: 0px;">
				...
				<span style="margin-left: auto; margin-right: 10px;">
					<div class="row">
						<?php
						if ($do == '1') {
							echo '<button type="button" class="btn btn-primary d-none d-md-block dropdown-toggle mr-4" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding: 10px; margin-left: 10px;">Dostosuj kanał</button>
